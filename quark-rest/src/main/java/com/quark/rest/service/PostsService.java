...
public interface PostsService extends BaseService<Posts> {
     ...
     * @param labelId 标签id
     */
    Integer savePosts(Posts posts,Integer labelId,User user);
    /**
     * 翻页查询帖子
     * @param type
     * @param search
    ...
    Page<Posts> getPostsByPage(String type ,String search, int pageNo,int length, String token, int showschool, Integer labelId);
